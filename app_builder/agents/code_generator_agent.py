...
"""
    ...
    app_js.extend([
        "function App() {",
        "  const backendUrl = (process.env.REACT_APP_BACKEND_URL || 'http://localhost:5003').trim();",
        "  return (",
        "    <div className=\"app\">",
    ...
    files["README.md"] = "# Generated App\\n\\n## Backend\\ncd backend && pip install -r requirements.txt && uvicorn main:app --reload --port 5003\\n\\n## Frontend\\ncd frontend && npm install && npm start"
    return files
    return files
