...
"""
    ...
    app_js.extend([
        "function App() {",
        "  const backendUrl = (process.env.REACT_APP_BACKEND_URL || 'http://localhost:5002').trim();",
        "  return (",
        "    <div className=\"app\">",
    ...
    files["README.md"] = "# Generated App\\n\\n## Backend\\ncd backend && pip install -r requirements.txt && uvicorn main:app --reload --port 5002\\n\\n## Frontend\\ncd frontend && npm install && npm start"
    return files
    return files
