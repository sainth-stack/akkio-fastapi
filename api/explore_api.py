...
def handle_general_question(query: str) -> str:
    ...
    if is_arabic:
        ...
        if any(greeting in q for greeting in ['hi', 'hello', 'hey', 'مرحبا', 'أهلا', 'السلام عليكم']):
            ...
            return '<div dir="rtl" lang="ar"><h3>نظام التحليل القانوني</h3><h4>مرحبا بك!</h4><p>أهلا وسهلا بك في نظام التحليل القانوني المتقدم. أنا هنا لمساعدتك في الشؤون القانونية الإماراتية.</p><h4>كيف يمكنني مساعدتك؟</h4><ul><li><strong>التحليل القانوني:</strong> تحليل الوثائق القانونية والملفات PDF</li><li><strong>الاستفسارات القانونية:</strong> الإجابة على أسئلتك حول القوانين واللوائح</li><li><strong>الغرامات والعقوبات:</strong> توضيح الغرامات والعقوبات المطبقة</li></ul><hr><h4>المراجع القانونية</h4><p><strong>المصدر:</strong> <a href="https://uaelegislation.gov.ae" target="_blank" style="color: #3498db;">https://uaelegislation.gov.ae</a></p><p><strong>مرجع إضافي:</strong> <a href="https://www.moj.gov.ae" target="_blank" style="color: #3498db;">https://www.moj.gov.ae</a></p></div>'
    else:
        # English responses
        if any(greeting in q for greeting in ['hi', 'hello', 'hey', 'good morning', 'good afternoon', 'good evening']):
            return "<h3>LEGAL ANALYSIS SYSTEM</h3><h4>Hello there!</h4><p>Welcome to our advanced Legal Analysis System! I'm your intelligent assistant specialized in UAE legal document analysis and processing.</p><h4>How can I help you with legal matters today?</h4><ul><li><strong>Legal Analysis:</strong> I can analyze legal documents and PDF files</li><li><strong>Legal Queries:</strong> I can answer questions about UAE laws and regulations</li><li><strong>Penalties & Fines:</strong> I can explain applicable penalties and fines</li><li><strong>Administrative Regulations:</strong> I can explain government decisions and decrees</li></ul><p>What legal question would you like to ask?</p><hr><h4>Legal References</h4><p><strong>SOURCE:</strong> <a href=\"https://uaelegislation.gov.ae\" target=\"_blank\" style=\"color: #3498db;\">https://uaelegislation.gov.ae</a></p><p><strong>Additional Reference:</strong> <a href=\"https://www.moj.gov.ae\" target=\"_blank\" style=\"color: #3498db;\">https://www.moj.gov.ae</a></p>"
        elif any(greeting in q for greeting in ['thanks', 'thank you']):
            return "<h3>LEGAL ANALYSIS SYSTEM</h3><h4>You're welcome!</h4><p>I'm glad I could help with your legal inquiry! If you have any other legal questions, feel free to ask.</p><hr><h4>Legal References</h4><p><strong>SOURCE:</strong> <a href=\"https://uaelegislation.gov.ae\" target=\"_blank\" style=\"color: #3498db;\">https://uaelegislation.gov.ae</a></p><p><strong>Additional Reference:</strong> <a href=\"https://www.moj.gov.ae\" target=\"_blank\" style=\"color: #3498db;\">https://www.moj.gov.ae</a></p>"
        elif any(greeting in q for greeting in ['bye', 'goodbye', 'see you']):
            return "<h3>LEGAL ANALYSIS SYSTEM</h3><h4>Goodbye!</h4><p>Have a great day! See you soon!</p><hr><h4>Legal References</h4><p><strong>SOURCE:</strong> <a href=\"https://uaelegislation.gov.ae\" target=\"_blank\" style=\"color: #3498db;\">https://uaelegislation.gov.ae</a></p><p><strong>Additional Reference:</strong> <a href=\"https://www.moj.gov.ae\" target=\"_blank\" style=\"color: #3498db;\">https://www.moj.gov.ae</a></p>"
        elif not is_legal_question:
            # Non-legal question - redirect to legal topics
            ...
            return "<h3>LEGAL ANALYSIS SYSTEM</h3><h4>Hello!</h4><p>Welcome to our advanced Legal Analysis System! I'm here to help you with UAE legal matters.</p><h4>How can I assist you?</h4><ul><li><strong>Legal Analysis:</strong> Analyze legal documents and PDF files</li><li><strong>Legal Queries:</strong> Answer questions about laws and regulations</li><li><strong>Penalties & Fines:</strong> Explain applicable penalties and fines</li></ul><hr><h4>Legal References</h4><p><strong>SOURCE:</strong> <a href=\"https://uaelegislation.gov.ae\" target=\"_blank\" style=\"color: #3498db;\">https://uaelegislation.gov.ae</a></p><p><strong>Additional Reference:</strong> <a href=\"https://www.moj.gov.ae\" target=\"_blank\" style=\"color: #3498db;\">https://www.moj.gov.ae</a></p>"
...
- CRITICALLY IMPORTANT: ALWAYS end your conversational responses with legal references:
  For Arabic: <hr><h4>المراجع القانونية</h4><p><strong>المصدر:</strong> <a href="https://uaelegislation.gov.ae" target="_blank" style="color: #3498db;">https://uaelegislation.gov.ae</a></p><p><strong>مرجع إضافي:</strong> <a href="https://www.moj.gov.ae" target="_blank" style="color: #3498db;">https://www.moj.gov.ae</a></p>
...
- Be helpful and engaging
- CRITICALLY IMPORTANT: ALWAYS end your conversational responses with legal references:
  For English: <hr><h4>Legal References</h4><p><strong>SOURCE:</strong> <a href="https://uaelegislation.gov.ae" target="_blank" style="color: #3498db;">https://uaelegislation.gov.ae</a></p><p><strong>Additional Reference:</strong> <a href="https://www.moj.gov.ae" target="_blank" style="color: #3498db;">https://www.moj.gov.ae</a></p>
